...
variables <- list(
  ...
  "numeric" = c("mean", "sd", "median", "qXX", "min", "max", "sum", "count_missing", "percentage_missing", "count", "percentage"),
  "integer" = c("mean", "sd", "median", "qXX", "min", "max", "sum", "count_missing", "percentage_missing", "count", "percentage"),
