...
cdm$exposure_cohort_set <- con %>% dplyr::tbl(in_schema(
  "main",
  "exposure_cohort_set"
))
cdm$exposure_cohort_count <- con %>% dplyr::tbl(in_schema(
  "main",
...
cdm$gi_bleed_cohort_set <- con %>% dplyr::tbl(in_schema(
  "main",
  "gi_bleed_set"
))
cdm$gi_bleed_cohort_count <- con %>% dplyr::tbl(in_schema(
  "main",
  "gi_bleed_count"
))
