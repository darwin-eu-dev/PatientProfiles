---
title: "PaRe Report: PatientProfiles [0.2.0]"
...
output:
  html_document:
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{PatientProfiles [0.2.0]}
...
tempDir <- tempdir()
pathToRepo <- file.path(tempDir, "PatientProfiles")

git2r::clone(
  url = "https://github.com/darwin-eu-dev/PatientProfiles.git",
