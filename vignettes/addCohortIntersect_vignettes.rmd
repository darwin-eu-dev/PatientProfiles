...
As you see from the result above, it added 4 extra columns "all_0_to_Inf","all_0_to_Inf_1","all_0_to_Inf_2","all_0_to_Inf_3". The columns are name as "{cohortNames}_{window}_{window of interests}_{number_if_repeated}".
