test_that("sex, no missing",{
  cdm <- mockDrugUtilisation(seed = 27, patient_size = 10, earliest_observation_start_date = as.Date("2010-01-01"), latest_observation_start_date = as.Date("2022-01-01"))
...
test_that("sex, person_id",{
  cdm <- mockDrugUtilisation(seed = 8, patient_size = 10, earliest_observation_start_date = as.Date("2010-01-01"), latest_observation_start_date = as.Date("2022-01-01"))
...
test_that("expected errors",{
  cdm <- mockDrugUtilisation(seed = 100, patient_size = 10, earliest_observation_start_date = as.Date("2010-01-01"), latest_observation_start_date = as.Date("2022-01-01"))
